...
General support for these images and home of this project are at: 
    https://github.com/martinkozak/ec2build
    https://github.com/martinkozak/linux-ec2

You probably should initialize the archlinux-keyring now by running:
