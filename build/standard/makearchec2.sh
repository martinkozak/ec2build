...
curl -o $ROOT/root/.zshrc  "https://raw.github.com/martinkozak/ec2build/master/build/standard/.zshrc"
...
curl -L -o $ROOT/root/repo/ec2-metadata-0.1-1-any.pkg.tar.xz https://github.com/martinkozak/ec2build/raw/master/repo/ec2-metadata-0.1-1-any.pkg.tar.xz
curl -L -o $ROOT/root/repo/ec2arch-1.0-1-any.pkg.tar.xz https://github.com/martinkozak/ec2build/raw/master/repo/ec2arch-1.0-1-any.pkg.tar.xz
curl -L -o $ROOT/root/repo/linux-ec2-3.1-4-$ARCH.pkg.tar.xz http://c263555.r55.cf1.rackcdn.com/linux-ec2-3.1-4-$ARCH.pkg.tar.xz
curl -L -o $ROOT/root/repo/linux-ec2-headers-3.1-4-$ARCH.pkg.tar.xz http://c263555.r55.cf1.rackcdn.com/linux-ec2-headers-3.1-4-$ARCH.pkg.tar.xz
